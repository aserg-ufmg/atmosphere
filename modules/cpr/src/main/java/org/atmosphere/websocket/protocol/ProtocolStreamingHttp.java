 ...
 */
public class ProtocolStreamingHttp implements WebSocketProtocolStream {

    private static final Logger logger = LoggerFactory.getLogger(ProtocolStreamingHttp.class);
    protected final static String TEXT = "text/plain";
    protected String contentType = "text/plain";
    protected String methodType = "POST";
    protected String delimiter = "@@";
    protected boolean destroyable;
    private final ProtocolSimpleHttp delegate;

    public ProtocolStreamingHttp(){
        delegate = new ProtocolSimpleHttp();
    }
